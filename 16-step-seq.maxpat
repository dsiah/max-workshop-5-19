...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 108.0, 109.0, 30.0, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 162.0, 51.0, 37.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.0, 51.0, 30.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 216.0, 51.0, 30.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 108.0, 51.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 108.0, 80.0, 181.0, 22.0 ],
					"text" : "tempo 120 1 16"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 108.0, 679.0, 141.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 108.0, 742.0, 44.0, 44.0 ],
...
,
					"patching_rect" : [ 108.0, 636.0, 48.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 356.5, 18.0, 41.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 356.5, 109.0, 55.0, 22.0 ],
					"text" : "mode $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 356.5, 46.0, 147.5, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 513.5, 32.5, 113.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "", "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 108.0, 184.0, 937.294117647058783, 398.350000000000023 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
					"stepcolor2" : [ 0.901960784313726, 0.776470588235294, 0.517647058823529, 1.0 ],
					"varname" : "live.step"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 366.0, 103.0, 347.0, 103.0, 347.0, 10.0, 366.0, 10.0 ],
					"order" : 1,
					"source" : [ "obj-67", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 366.0, 156.0, 117.5, 156.0 ],
					"source" : [ "obj-70", 0 ]
				}
...
,
		"dependency_cache" : [  ],
		"autosave" : 0,
		"clearcolor" : [ 0.756862745098039, 0.105882352941176, 0.105882352941176, 0.0 ]
	}
